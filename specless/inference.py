...
class TPOInferenceAlgorithm(InferenceAlgorithm):
    ...
    InferenceAlgorithm : InferenceAlgorithm
        The base class for inference algorithms.
    """
    ...
    def __init__(
        ...
        """
        Initialize the TPOInferenceAlgorithm.

        Parameters
        ----------
        heuristic : str, optional
            The heuristic to use for the inference algorithm. Default is "order".
        decimals : int, optional
            The number of decimal places to use for the inference algorithm. Default is 2.
        threshold : float, optional
            The threshold to use for the inference algorithm. Default is 0.5.
        """
        super().__init__()
    ...
    def infer(self, dataset: Dataset) -> Union[Specification, Exception]:
        ...
        ----------
        dataset : Dataset
            The dataset of timed traces to infer the TPO from.

        Returns
        -------
        Union[Specification, Exception]
            The inferred TPO, or an exception if the inference failed."""
    ...
    def infer_time_constraints(
        ...
        ----------
        traces : TimedTraceList
            The list of timed traces.
        po : PartialOrder
            The partial order.
        partial_order : Dict[str, List[str]]
            The dictionary of partial orders.
        debug : bool, optional
            Whether to print debug information. Default is False.
        decimals : Optional[int], optional
            The number of decimal places to use. Default is None.
        threshold : Optional[float], optional
            The threshold to use. Default is None.

        Returns
        -------
        Tuple
            The inferred time constraints.
        """
        if decimals is None:
